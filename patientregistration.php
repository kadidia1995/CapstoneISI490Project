  ...
  <main class="hoc container clear"> 
				<div class="panel-heading">
	               ...
	               <div class="panel-title text-center">
	               		<h1 class="title">Patient Registration Form</h1>
	               		<hr />
				...
				<div class="main-login main-center">
					<form class="form-horizontal" method="post" action="#">
						...
						<div class="form-group ">
						<input type="submit" class="bt-reg btn btn-primary btn-lg btn-block login-button" name="btnreg" value="Register" />
						</div>
					</form>
					</div>
<?php
		if(isset($_POST['btnreg']))
		{
			...
			$p=md5($password);
							//Query start
							//MD5('".$userpass."')
							$checkname="SELECT username FROM user_registration WHERE username='$username' and Status='patient'";
							...
							else
							{
								...
								else
								{
									...
									if ($password==$confirm) 
									{
										$sql="insert into user_registration values(null,'$name','$phoneNumber','$address','$city','$username','$p','patient')";
