...
<table id="example" class="display" style="width:100%">
        ...
        <tbody>
					...
					?>
					<tr>    
						<td style="text-align:center;"><?php echo $fetch['storeID']?></td>
						<td style="text-align:center;"><?php echo $fetch['storePhone']?></td>
						<td style="text-align:center;"><?php echo $fetch['storeAddress']?></td>
