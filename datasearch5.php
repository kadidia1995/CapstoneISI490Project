...
<table id="example" class="display" style="width:100%">
        ...
        <tbody>
					...
					$query="SELECT * FROM prescription pr INNER JOIN patients pa ON pr.prescriptionID=pa.prescriptionID INNER JOIN medictaion_history m ON pr.medication_NDC=m.medication_NDC INNER JOIN doctor d ON pr.doctor_npi=d.doctor_npi where pa.uId=$id";
